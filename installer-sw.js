const CACHE_NAME='techgeekph-installer-v1';
const APP_SHELL=[
...
self.addEventListener('fetch',event=>{
  ...
  // Keep technician workflow/data fresh. Fall back to cache if offline.
  if(url.pathname.includes('technician-checklist') || url.pathname.includes('technician-live-sync') || url.pathname.includes('service-catalog')){
