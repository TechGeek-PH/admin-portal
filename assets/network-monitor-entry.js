...
function makeTile(){const a=document.createElement('a');a.className='tile';a.href='network-monitor.html';a.dataset.title='Network Monitor';a.dataset.networkMonitorModule='1';a.innerHTML='<span class="ico">📡</span><b>Network Monitor</b><small>Live ping, offline clients and possible fiber cut alerts</small>';return a}
