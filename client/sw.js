const CACHE='techgeekph-client-v4';
...
self.addEventListener('fetch',e=>{
  ...
  const dynamic=e.request.mode==='navigate'||/\/client\/(?:index\.html|app\.js|chat-center\.js)?$/i.test(u.pathname)||/\/assets\/supabase-config\.js$/i.test(u.pathname);
  if(dynamic){
