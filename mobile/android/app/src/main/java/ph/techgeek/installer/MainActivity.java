...
public class MainActivity extends Activity {
    ...
    private void showWebError(String detail) {
        ...
        String html = "<html><meta name='viewport' content='width=device-width,initial-scale=1'>" +
                ...
                "<h2>TechGeekPH</h2><p>Unable to load the app.</p>" +
                "<p style='color:#64748b'>" + escapeHtml(safe) + "</p>" +
                "<button style='padding:12px 20px;border:0;border-radius:10px;background:#064f83;color:white' " +
                "onclick=\"location.href='" + APP_URL + "&t='+Date.now()\">Retry</button>" +
                "</body></html>";
    ...
    private void showNativeError(Throwable error) {
        ...
        text.setText("TechGeekPH\n\nThe embedded browser could not start on this phone.\nPlease update Chrome / Android System WebView, then open TechGeekPH again.\n\nError: " + error.getClass().getSimpleName());
        text.setTextSize(17);
        ...
        TextView openBrowser = new TextView(this);
        openBrowser.setText("\nOPEN TECHGEEKPH IN BROWSER");
        openBrowser.setTextSize(15);
        openBrowser.setTextColor(Color.rgb(0, 102, 204));
        openBrowser.setGravity(Gravity.CENTER);
        openBrowser.setPadding(20, 20, 20, 20);
        ...
        box.addView(openBrowser, new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT));
